...
export const lockupAccountSnapshots: readonly AccountLockup[] = [
  ...
  // transaction on block: 20145563 receipt executed: 20145564
  {
    ...
    liquidAmount: new BN("1000000000022659328465700000000").sub(new BN("1000000000000000000000000000000")),
  ...
  // transaction on block: 43794572 receipt executed: 43794573
  {
    ...
    liquidAmount: new BN("47090070022372502795500000000").sub(new BN("47090070000000000000000000000")),
  ...
  // transaction on block: 19145906 receipt executed: 19145907
  {
    ...
    liquidAmount: new BN("1900000000023506883760900000000").sub(new BN("1900000000000000000000000000000")),
