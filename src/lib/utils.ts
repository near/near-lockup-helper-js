 ...
 */
 export const formatVestingInfo = (info: VestingInformation): string | undefined => {
...
export const formatReleseDuration = (releaseDuration: BN): BN => (
  releaseDuration.div(new BN("1000000000"))
  .divn(60)
  .divn(60)
  .divn(24)
);
...
export const getStartLockupTimestamp = (
  ...
  const timestamp = BN.max(
    phase2Time.add(lockupDuration),
    lockupTimestamp
  );
 ...
 */
export const getVestingInformation = (reader: BinaryReader): VestingInformation => {
 ...
 */
export const getTransferInformation = (reader: BinaryReader): TransferInformation => {
